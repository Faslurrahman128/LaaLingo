...
import 'package:LaaLingo/ResourcePage/additionallang.dart';
import 'package:LaaLingo/chatroom/activity.dart';
import 'package:LaaLingo/leaderboard/leaderboard.dart';
import 'package:LaaLingo/progress_brain.dart/progress.dart';
import 'package:flutter_svg/svg.dart';
import 'package:LaaLingo/screens/image.dart';
import 'package:LaaLingo/screens/initallang.dart';
import 'package:LaaLingo/screens/login_page.dart';
import 'package:LaaLingo/utils/fire_auth.dart';
...
class _ProfilePageState extends State<ProfilePage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    final currentSlot = getLangSlot(userRow, currentLang);
    lang = (currentSlot?['Selected_lang'] is List)
      ? (currentSlot?['Selected_lang'])
      : [];

    print(userRow);
    final countLang = deriveCountLang(userRow);
    for (var i = 1; i <= countLang; i++) {
